...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-4 lg:p-6 pt-14 lg:pt-20 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
interface SheetContentProps
  ...
  VariantProps<typeof sheetVariants> { otherSide?: React.ReactNode }

const SheetContent = React.forwardRef<
  React.ElementRef<typeof SheetPrimitive.Content>,
  SheetContentProps
>(({ side = "right", className, children, otherSide, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      <div>
        ...
        <div className={`absolute ${side === "right" ? "right-2 lg:right-4" : "left-2 lg:left-4"} top-4 lg:top-6`}>
          {otherSide}
        </div>
      </div>
      {children}
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 overflow-y-auto h-full pr-2",
      className
    )}
    {...props}
  />
